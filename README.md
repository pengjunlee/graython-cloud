...
<h1 align="center" style="margin: 30px 0 30px; font-weight: bold;">RuoYi vG.1.0</h1>
<h4 align="center">基于 Vue/Element UI 和 Spring Boot/Spring Cloud & Alibaba 前后端分离的分布式微服务架构</h4>
<p align="center">
	<a href="https://gitee.com/y_project/RuoYi-Cloud/stargazers"><img src="https://gitee.com/y_project/RuoYi-Cloud/badge/star.svg?theme=dark"></a>
	<a href="https://gitee.com/y_project/RuoYi-Cloud"><img src="https://img.shields.io/badge/RuoYi-vG.1.0-brightgreen.svg"></a>
...
* 阿里云优惠券：[点我进入](http://aly.graython.vip)，腾讯云优惠券：[点我进入](http://txy.graython.vip)&nbsp;&nbsp;
...
com.pengjunlee     
├── graython-ui              // 前端框架 [80]
├── graython-gateway         // 网关模块 [8080]
├── graython-auth            // 认证中心 [9200]
├── graython-api             // 接口模块
│       └── graython-api-system                          // 系统接口
├── graython-common          // 通用模块
│       └── graython-common-core                         // 核心模块
│       └── graython-common-datascope                    // 权限范围
│       └── graython-common-datasource                   // 多数据源
│       └── graython-common-log                          // 日志记录
│       └── graython-common-redis                        // 缓存服务
│       └── graython-common-seata                        // 分布式事务
│       └── graython-common-security                     // 安全模块
│       └── graython-common-sensitive                    // 数据脱敏
│       └── graython-common-swagger                      // 系统接口
├── graython-modules         // 业务模块
│       └── graython-system                              // 系统模块 [9201]
│       └── graython-gen                                 // 代码生成 [9202]
│       └── graython-job                                 // 定时任务 [9203]
│       └── graython-file                                // 文件服务 [9300]
├── graython-visual          // 图形化管理模块
│       └── graython-visual-monitor                      // 监控中心 [9100]
├──pom.xml                // 公共依赖
~~~
...
演示地址：http://graython.vip  
文档地址：http://doc.graython.vip
